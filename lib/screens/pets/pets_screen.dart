              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.pets, color: AppColors.primaryLight),
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.category_outlined, color: AppColors.primaryLight),
                  ),
                ),
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Gender *',
                    prefixIcon: Icon(Icons.male, color: AppColors.primaryLight),
                  ),
                  items: const [
                ...
                InkWell(
                  ...
                  child: InputDecorator(
                    decoration: const InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.calendar_today, color: AppColors.primaryLight),
                    ),
                    child: Text(
                      birthDate != null
                          ...
                          : 'Pilih tanggal',
                      style: TextStyle(
                        color: birthDate != null ? AppColors.textBody : AppColors.textGray,
                      ),
                    ),
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.monitor_weight_outlined, color: AppColors.primaryLight),
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.star_outline, color: AppColors.primaryLight),
                  ),
                ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.warning_amber, color: AppColors.primaryLight),
                  ),
                ),
                    ...
                    onPressed: () async {
                      if (nameC.text.isEmpty || speciesC.text.isEmpty || birthDate == null) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Nama, Jenis, dan Tanggal Lahir wajib diisi'),
                          ),
                        );
                        return;
                      }
